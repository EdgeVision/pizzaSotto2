package com.example.stiffix.pizzasotto;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            iconImageView.setImageDrawable(getContext().getResources().getDrawable(R.drawable.settings));
            ...
            tabTitleView.setTextColor(R.color.testing);
